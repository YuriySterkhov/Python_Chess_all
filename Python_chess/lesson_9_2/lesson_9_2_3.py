...
class ChessGame(QMainWindow):
    def __init__(self):
        ...
        # Шахматная доска
        self.board = chess.Board('5K2/p6k/8/8/8/8/8/8 w - - 0 1')
    ...
    def update_animation(self):
        ...
        if self.step == 0:
            # Два короля и пешка
            self.board.clear()
            self.board.set_piece_at(chess.F8, chess.Piece(chess.KING, chess.WHITE))
            ...
            # Очистка доски, установка королей и пешки
            self.board.clear()
            self.board.set_piece_at(chess.D6, chess.Piece(chess.KING, chess.WHITE))
            self.board.set_piece_at(chess.H7, chess.Piece(chess.KING, chess.BLACK))
            self.board.set_piece_at(chess.A5, chess.Piece(chess.PAWN, chess.BLACK))
            ...
            # Очистка доски, установка королей и пешки
            self.board.clear()
            self.board.set_piece_at(chess.C5, chess.Piece(chess.KING, chess.WHITE))
            self.board.set_piece_at(chess.H7, chess.Piece(chess.KING, chess.BLACK))
            self.board.set_piece_at(chess.A4, chess.Piece(chess.PAWN, chess.BLACK))
            ...
            # Очистка доски, установка королей и пешки
            self.board.clear()
            self.board.set_piece_at(chess.B4, chess.Piece(chess.KING, chess.WHITE))
            self.board.set_piece_at(chess.H7, chess.Piece(chess.KING, chess.BLACK))
            self.board.set_piece_at(chess.A3, chess.Piece(chess.PAWN, chess.BLACK))
            ...
            # Очистка доски, установка королей и пешки
            self.board.clear()
            self.board.set_piece_at(chess.A3, chess.Piece(chess.KING, chess.WHITE))
            self.board.set_piece_at(chess.H7, chess.Piece(chess.KING, chess.BLACK))
            self.board.set_piece_at(chess.A2, chess.Piece(chess.PAWN, chess.BLACK))
            ...
            self.board.set_piece_at(chess.A3, chess.Piece(chess.KING, chess.WHITE))
            self.board.set_piece_at(chess.H7, chess.Piece(chess.KING, chess.BLACK))
            self.board.set_piece_at(chess.A1, chess.Piece(chess.QUEEN, chess.BLACK))
