...
class ChessAnimation(QMainWindow):
    def __init__(self):
        ...
        self.positions = {
            'позиция_1': {'fen': '8/8/6b1/8/2k5/8/2p1K3/1R1R4 b - - 0 1', 'display_time': 10},
            'позиция_2': {'fen': '8/5P1k/5P2/7K/8/8/8/8 w - - 0 1', 'display_time': 5},
            'позиция_3': {'fen': '8/8/8/8/8/2k5/K1p5/8 b - - 0 1', 'display_time': 5},
            'позиция_4': {'fen': '8/1k1P1q2/8/8/4K3/8/2B5/8 w - - 0 1', 'display_time': 5},
            # Другие позиции по необходимости
        }
    
        self.moves_dict = {
            'позиция_1': [chess.Move.from_uci(m) for m in ["c2d1q"]],
            'позиция_2': [chess.Move.from_uci(m) for m in ["h5g5", "h7h8", "f7f8q", "h8h7", "f8g7"]],
