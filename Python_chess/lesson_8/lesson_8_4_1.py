...
class ChessGame(QMainWindow):
    def __init__(self):
        ...
        # Шахматная доска
        self.board = chess.Board('8/8/4N1B1/8/8/2K5/8/2k5 b - - 0 1')
    ...
    def update_animation(self):
        ...
        if self.step == 0:
            ...
            self.board.set_piece_at(chess.G6, chess.Piece(chess.BISHOP, chess.WHITE))
            self.board.set_piece_at(chess.C1, chess.Piece(chess.KING, chess.BLACK))
